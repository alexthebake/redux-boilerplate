...
exports.dispatchAjaxAction = exports.createReducer = exports.ajaxActionType = undefined;
...
var _dispatchAjaxAction = __webpack_require__(6);

var _dispatchAjaxAction2 = _interopRequireDefault(_dispatchAjaxAction);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.ajaxActionType = _actionTypes.ajaxActionType;
exports.createReducer = _createReducer2.default;
exports.dispatchAjaxAction = _dispatchAjaxAction2.default;
...
exports.ajaxActionType = ajaxActionType;
function ajaxActionType(actionType) {
  return {
...
exports.default = dispatchAjaxAction;
/**
 ...
 */
function dispatchAjaxAction() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ajaxActionType = _ref.ajaxActionType,
      ajaxCallback = _ref.ajaxCallback;

  return function (dispatch) {
    // Dispatch LOADING action
    dispatch({ type: ajaxActionType.LOADING });
    // Make ajax request
    return ajaxCallback(dispatch).then(function (response) {
